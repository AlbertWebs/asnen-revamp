...
@section('content')
    <div class="admin-toolbar">
        <p class="admin-toolbar__copy">
            Manage articles and their publish status.
        </p>
        <div class="admin-toolbar__actions">
            @can('articles.create')
                <a href="{{ route('admin.articles.create') }}" class="admin-btn-primary">New</a>
            @endcan
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="admin-table__actions">
                                    @can('articles.update')
                                        <a href="{{ route('admin.articles.edit', $item) }}" class="admin-table__link">Edit</a>
                                    @endcan
