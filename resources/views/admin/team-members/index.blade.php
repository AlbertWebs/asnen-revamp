...
@section('content')
    <div class="admin-toolbar">
        <p class="admin-toolbar__copy">
            Manage team member profiles and their publish status.
        </p>
        <div class="admin-toolbar__actions">
            @can('team_members.create')
                <a href="{{ route('admin.team-members.create') }}" class="admin-btn-primary">New</a>
            @endcan
        </div>
    </div>
                            ...
                            <td class="text-right">
                                <div class="admin-table__actions">
                                    @can('team_members.update')
                                        <a href="{{ route('admin.team-members.edit', $item) }}" class="admin-table__link">Edit</a>
                                    @endcan
                                    @include('admin.partials.table-delete', [
                                        'action' => route('admin.team-members.destroy', $item),
                                        'permission' => 'team_members.delete',
                                        'label' => $item->name,
                                    ])
                                </div>
                            </td>
