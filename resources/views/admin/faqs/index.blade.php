...
@section('content')
    <div class="admin-toolbar">
        <p class="admin-toolbar__copy">
            Manage frequently asked questions and their publish status.
        </p>
        <div class="admin-toolbar__actions">
            @can('faqs.create')
                <a href="{{ route('admin.faqs.create') }}" class="admin-btn-primary">New</a>
            @endcan
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="admin-table__actions">
                                    @can('faqs.update')
                                        <a href="{{ route('admin.faqs.edit', $item) }}" class="admin-table__link">Edit</a>
                                    @endcan
                                    @include('admin.partials.table-delete', [
                                        'action' => route('admin.faqs.destroy', $item),
                                        'permission' => 'faqs.delete',
                                        'label' => \Illuminate\Support\Str::limit($item->question, 60),
                                    ])
                                </div>
                            </td>
                        </tr>
